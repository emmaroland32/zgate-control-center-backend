...
import com.zgate.nexus.repository.InvoiceRepository;
import com.zgate.nexus.service.BillingService;
import lombok.Data;
...
public class BillingController {
    ...
    public ResponseEntity<byte[]> downloadPdf(@PathVariable UUID id) {
        Invoice invoice = invoiceRepo.findById(id)
            .orElseThrow(() -> new com.zgate.nexus.exception.NexusException("Invoice not found: " + id));
